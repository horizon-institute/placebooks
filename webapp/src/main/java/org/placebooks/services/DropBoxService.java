...
//					"PlaceBooks", Locale.getDefault().toString());
//			final DbxSessionStore sessionStore = new DbxSessionStore()
//			{
//				@Override
//				public String get()
//				{
...
//				}
//			};
//			final DbxWebAuth webAuth = new DbxWebAuth(config, getAppInfo(), callbackURL, sessionStore);
//
...
//						webAuth..requestTokenPair.key, null, authInfo.requestTokenPair.secret);
