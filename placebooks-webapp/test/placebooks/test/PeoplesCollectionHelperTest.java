...
public class PeoplesCollectionHelperTest extends PlacebooksTestSuper {
	...
	/**
	 * Test method for {@link placebooks.controller.PeoplesCollectionHelper#Login(java.lang.String, java.lang.String)}.
	 */
	@Test
	public void testLogin() {
		PeoplesCollectionLoginResponse loginResponse =  PeoplesCollectionHelper.Login("fail-bad-user", "fail-bad-user");
		...
		loginResponse =  PeoplesCollectionHelper.Login("", "fail-no-user");
		...
		loginResponse =  PeoplesCollectionHelper.Login(test_peoplescollection_username, test_peoplescollection_password);
