...
public class PlaceBookMapsDialog extends PlaceBookDialog
{
	...
	public PlaceBookMapsDialog(final ItemController item, final List<PlaceBookItemFrame> mapItems)
	{
		...
		selectionModel.setSelected(ItemController.getMarkerImage(item.getItem()), true);		
	...
	private void onInitialize()
	{
		...
		{
			final String title = item.getItem().getMetadata().get("title");
