...
public class ToolbarPlaceItem extends Composite implements HasClickHandlers, HasMouseOverHandlers,
		HasMouseOutHandlers, HasHTML
{
	interface PlaceBookToolbarItemUiBinder extends UiBinder<Widget, ToolbarPlaceItem>
	{
	}
