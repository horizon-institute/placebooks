...
{	
	public final static OSLayer create(final String name, final ServerInfo serverInfo)
	{
		...
		return createLayer(name, serverInfo.getOpenSpaceHost(), serverInfo.getOpenSpaceBaseURL(), serverInfo.getOpenSpaceKey());
	}

	private final static native OSLayer createLayer(final String name, final String hostURL, final String tileURL, final String key)
	/*-{
