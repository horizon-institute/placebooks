...
public class Palette extends FlowPanel
{
	...
	private static final String NEW_GPS_ITEM = "{\"@class\":\"placebooks.model.GPSTraceItem\",\"sourceURL\":\"http://www.topografix.com/fells_loop.gpx\",\"metadata\":{\"title\":\"Test Route\"},\"parameters\":{\"height\":10000}}";
	...
	public void setPalette(final JsArray<PlaceBookItem> items, final PlaceBookEditor editor)
	{
		...
		root.add(new PaletteFolder("Test", root, this));
