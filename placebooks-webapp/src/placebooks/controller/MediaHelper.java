...
public class MediaHelper
{
	...
	private static final Logger log = 
		Logger.getLogger(MediaHelper.class.getName());
    ...
    public static final boolean accepts(final String acceptHeader, 
    ...
    public static final boolean matches(final String matchHeader, 
    ...
    public static final long sublong(final String value, 
									 final int beginIndex, final int endIndex) 
	{
     ...
     public static void copy(final RandomAccessFile input, 
