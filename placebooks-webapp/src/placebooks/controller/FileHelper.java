...
public class FileHelper
{
	...
	/**
	 * Attempt to find file in given dir, uses the first file found starting with the name if it's not.
	 * @param dir
	 * @param name
	 * @return
	 */
	public static String FindClosestFile(String dir, String name)
	{
		String itemPath = null;
		File serveFile = new File(dir + File.separator + name); 
		if(serveFile.exists())
		{
